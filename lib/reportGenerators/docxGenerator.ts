...
// US Letter 8.5" wide, 1" margins → content = 6.5" = 9360 DXA
...
export async function generateDocx(sprintData: any, ai: any, includeBlockerNotes: boolean = true): Promise<Buffer> {
  ...
  const COL_TEAM = [2340, 2160, 1080, 1080, 2700]; // sum = 9360
  ...
  const COL_TASK = [3240, 1260, 1260, 780, 2820]; // sum = 9360
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({ text: "SPRINT REPORT", font: "Calibri", size: 18, bold: true, color: COLOR.STEEL, characterSpacing: 150 }),
            ],
          }),
          new Paragraph({
            spacing: { before: 0, after: 80 },
            children: [
              new TextRun({ text: sprintData.sprintName, font: "Calibri", size: 52, bold: true, color: COLOR.NAVY }),
            ],
          }),
          new Paragraph({
            ...
            children: [
              new TextRun({ text: `${sprintData.startDate}  —  ${sprintData.endDate}`, font: "Calibri", size: 22, color: COLOR.MUTED }),
            ],
          }),
